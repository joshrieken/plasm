defmodule Plasm.Api.UpdatedAtTest do
  use Plasm.ApiCase

  test ".updated_at with an Ecto.DateTime" do
    ecto_date_time = Ecto.DateTime.utc

    plasm_query_string =
      Plasm.User
      |> Plasm.updated_at(ecto_date_time)
      |> query_to_string
