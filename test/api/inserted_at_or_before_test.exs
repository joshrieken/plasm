defmodule Plasm.Api.InsertedBeforeInclTest do
  ...
  test ".inserted_at_or_before with an Ecto.DateTime" do
    ...
    plasm_query_string =
      Plasm.User
      |> Plasm.inserted_at_or_before(ecto_date_time)
      |> query_to_string
  ...
  test ".inserted_at_or_before with a castable Ecto.DateTime" do
    castable_ecto_date_time = "2014-04-17T14:00:00Z"
    {:ok, ecto_date_time} = Ecto.DateTime.cast(castable_ecto_date_time)

    plasm_query_string =
      Plasm.User
      |> Plasm.inserted_at_or_before(castable_ecto_date_time)
      |> query_to_string
