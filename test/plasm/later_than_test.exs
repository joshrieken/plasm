defmodule Plasm.LaterThanTest do
  ...
  test ".later_than with an atom field name and Ecto.DateTime" do
    ...
    # Act
    user_ids = User |> Plasm.later_than(:inserted_at, Ecto.DateTime.cast!(castable_string)) |> Repo.all() |> Enum.map(&(&1.id))
  ...
  test ".later_than with an atom field name and Ecto.Date" do
    ...
    # Act
    user_ids = User |> Plasm.later_than(:inserted_at, Ecto.Date.cast!(castable_string)) |> Repo.all() |> Enum.map(&(&1.id))
