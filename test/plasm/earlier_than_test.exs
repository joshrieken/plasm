defmodule Plasm.EarlierThanTest do
  ...
  test ".earlier_than with an atom field name and Ecto.DateTime" do
    ...
    # Act
    users = User |> Plasm.earlier_than(:inserted_at, query_date_time) |> Repo.all
  ...
  test ".earlier_than with an atom field name and castable Ecto.DateTime" do
    ...
    # Act
    users = User |> Plasm.earlier_than(:inserted_at, castable_string) |> Repo.all
  ...
  test ".earlier_than with an atom field name and Ecto.Date" do
    ...
    # Act
    users = User |> Plasm.earlier_than(:inserted_at, query_date) |> Repo.all
