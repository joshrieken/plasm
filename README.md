...
Plasm.at(query, field_name, string_castable_to_ecto_date)
Plasm.at_or_later_than(query, field_name, ecto_date)
Plasm.at_or_later_than(query, field_name, string_castable_to_ecto_date)
Plasm.at_or_earlier_than(query, field_name, ecto_date)
Plasm.at_or_earlier_than(query, field_name, string_castable_to_ecto_date)
Plasm.earlier_than(query, field_name, ecto_date)
Plasm.earlier_than(query, field_name, string_castable_to_ecto_date)
Plasm.earlier_than(query, field_name, ecto_date_time)
Plasm.earlier_than(query, field_name, string_castable_to_ecto_date_time)
...
Plasm.later_than(query, field_name, ecto_date)
Plasm.later_than(query, field_name, string_castable_to_ecto_date)
Plasm.later_than(query, field_name, ecto_date_time)
Plasm.later_than(query, field_name, string_castable_to_ecto_date_time)
...
Plasm.on(query, field_name, string_castable_to_ecto_date)
Plasm.on_or_later_than(query, field_name, ecto_date)
Plasm.on_or_later_than(query, field_name, string_castable_to_ecto_date)
Plasm.on_or_earlier_than(query, field_name, ecto_date)
Plasm.on_or_earlier_than(query, field_name, string_castable_to_ecto_date)
Plasm.random(query)
